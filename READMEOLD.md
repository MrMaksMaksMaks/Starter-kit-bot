...
| 📊 **BПроверка баланса** | Просмотр баланса SOL и SPL-токенов |
| 💰 **RРеферальная программа** | Монетизация через Jupiter Referral |
...
- **Openfort** — управление кошельками и подпись транзакци
